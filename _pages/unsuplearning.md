...
!["Dry Bean dataset clustering scatter plot"](/assets/images/p1_drybean_clustering_scat.png "Dry Bean dataset clustering scatter plot"){:.project-image}

!["Obesity dataset clustering scatter plot"](/assets/images/p1_obesity_clustering_scat.png "Obesity dataset clustering scatter plot"){:.project-image}
...
!["Neural network performance table"](/assets/images/neuralnetwork_dimred_clustering.png "Neural network performance table"){:.project-image-large}
...
!["Dry Bean and Obesity dataset PCA projections"](/assets/images/p2_pca_projections.png "Dry Bean and Obesity dataset PCA"){:.project-image-small}

!["Dry Bean and Obesity dataset ICA projections"](/assets/images/p2_ica_projections.png "Dry Bean and Obesity dataset ICA projections"){:.project-image-small}
